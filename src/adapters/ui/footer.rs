...
impl Component for FooterComponent {
    ...
    fn draw(&self, f: &mut Frame<'_>, area: Rect, state: &mut Self::State, _ctx: &Self::Context) {
        ...
        spans.extend(vec![
            ...
            Span::styled("│ ", Style::default().fg(border_dark)),
            Span::styled("n/p ", Style::default().fg(primary)),
            Span::styled("Hunk ", Style::default().fg(Palette::TEXT_BRIGHT)),
            Span::styled("│ ", Style::default().fg(border_dark)),
            Span::styled("f ", Style::default().fg(primary)),
            Span::styled("Fold ", Style::default().fg(Palette::TEXT_BRIGHT)),
            Span::styled("│ ", Style::default().fg(border_dark)),
            Span::styled("^F ", Style::default().fg(primary)),
            Span::styled("Search ", Style::default().fg(Palette::TEXT_BRIGHT)),
            Span::styled("│ ", Style::default().fg(border_dark)),
            Span::styled("o ", Style::default().fg(primary)),
            Span::styled("Syms ", Style::default().fg(Palette::TEXT_BRIGHT)),
            Span::styled("│ ", Style::default().fg(border_dark)),
            Span::styled("/ ", Style::default().fg(primary)),
