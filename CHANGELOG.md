...
### Added
- Sponsor integration: official Buy Me a Coffee button in README and interactive demo page.
- `.github/FUNDING.yml` for GitHub's native "Sponsor this project" button.
- Open Graph and Twitter Card meta tags in `docs/index.html` for richer social sharing.
- Downloads and Stars badges in README header.
